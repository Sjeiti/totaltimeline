...
function formatAnnum(year,round,noSlug){
  ...
  var sReturn
  var isFuture = year<0
  var iYear = Math.abs(year)
  var space = noSlug===false?'':sSpace
...
function unformatAnnum(formatted){
  ...
  var sString = aString?aString[0]:''
  var aNumber = formatted.match(/[0-9\.]+/)
  var fNumber = aNumber&&parseFloat(aNumber[0])||0 // odo: Uncaught TypeError: Cannot read property '0' of null
  var iAgo = fNumber
